...
<head>
  ...
  src="https://maps.google.com/maps/api/js?v=3.exp&sensor=false&libraries=visualization">
  </script>
...
var sentData=<?php print_r(json_encode($sentData)); ?>;
var testData=[];
    for(count=0; count< sentData.length; count++) {
    var lat = sentData[count][0];
    var lng = sentData[count][1];

    testData.push (new google.maps.LatLng(lat, lng));
    }
